                                        ...
                                        @auth
                                            @if(Auth::user()->utype==='ADM')
                                                <li class="menu-item menu-item-has-children parent">
                                                    <a title="My Account" href="" class="fa fa-angle-down"aria-hidden="true">My Account ({{Auth::user()->name}})</a>
                                            ...
                                            @else
                                                <li class="menu-item menu-item-has-children parent">
                                                    <a href="#" class="fa fa-angle-down"aria-hidden="true">My Account({{Auth::user()->name}})</a>
                                                <ul class="submenu currency">
                                                    <li class="menu-item">
